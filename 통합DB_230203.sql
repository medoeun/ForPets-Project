...
ALTER TABLE USER_PET ADD weight NUMBER(2);
ALTER TABLE USER_PET ADD pet_type_detail VARCHAR2(20);
ALTER TABLE USER_PET ADD license VARCHAR2(20);
ALTER TABLE USER_PET ADD is_neutered CHAR(1);
ALTER TABLE USER_PET ADD pet_social VARCHAR2(20);
ALTER TABLE USER_PET ADD is_vaccin VARCHAR2(8);
